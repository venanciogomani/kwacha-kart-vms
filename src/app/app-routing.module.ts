...
import { UpdateStoreComponent } from './pages/stores/update-store/update-store.component';
...
import { StoreTeamComponent } from './pages/stores/store-team/store-team.component';
